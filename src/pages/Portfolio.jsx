              ...
              >
                <div className='project-text'>
                  ...
                  <div className='flex gap-8'> 
                    {
                      item.githubLinkFront === "/" ? <span  className="px-3 py-1 cursor-pointer rounded-[40px] border-solid border-2 transition duration-500 ease-in-out dark:text-white hover:bg-[#6c757d] hover:text-white border-[#6c757d]" > Comming soon ...</span>
                    ...
                    {      
                      item.githubLinkBack === "/" ? <span  className="px-3 py-1 cursor-pointer rounded-[40px] border-solid border-2 transition duration-500 ease-in-out dark:text-white hover:bg-[#6c757d] hover:text-white border-[#6c757d]" > Comming soon ...</span>              
                  ...
                  {
                    item.demoLink === "/" ? <span className="px-3 py-1 rounded-[40px] border-solid border-2 transition duration-500 ease-in-out dark:text-white cursor-pointer hover:bg-[#007bff] hover:text-white border-[#007bff]"> Comming soon ... </span> 
